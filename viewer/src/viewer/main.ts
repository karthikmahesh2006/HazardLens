...
const ground=new THREE.Mesh(new THREE.PlaneGeometry(70,50),new THREE.MeshStandardMaterial({color:0x111820})); ground.rotation.x=-Math.PI/2; scene.add(ground); createFacility(scene);
