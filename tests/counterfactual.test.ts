...
import { PipeTwin, SuppressionTwin, TankTwin, ValveTwin, WorkerTwin } from '../src/twins/process.js';
...
test('ViewerSimulation counterfactual engine calculates loss avoided and prevents BLEVE', () => {
  ...
  const result = sim.evaluateCounterfactual(
    'Emergency ESDV Isolation + Process Deluge',
    s => {
